...
export const sendFriendRequest = async (req, res) => {
    try {
        ...
        if (existingRequest) {
            return res.status(400).json({ message: "Đã có lời mời kết bạn tồn tại giữa hai người" });
        }
...
export const getAllFriends = async (req, res) => {
    try {
        ...
        }).populate("userA","_id displayName avatarUrl username").populate("userB","_id displayName avatarUrl username").lean();
